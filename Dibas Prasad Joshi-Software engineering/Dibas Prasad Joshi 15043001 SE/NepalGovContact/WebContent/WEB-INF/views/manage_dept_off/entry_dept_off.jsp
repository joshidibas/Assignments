...
<script src="${pageContext.request.contextPath}/resources/js/jquery.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/dept_off_add.js"></script>
...
<TABLE BORDER="1">
  <TR>
   ...
   <TR>
    ...
    <TD>
      <select id="dept_combo" name="dept_combo">
    </TD>
  </TR>
  <TR>
    <TD>Office Code:</TD>
...
<input type="submit" name="btn_add_dept_office" id ="btn_add_dept_office" value="SAVE OFFICE">
<input type="hidden" name="mypage" value="entry_dept_off">
</form>
