...
<script src="${pageContext.request.contextPath}/resources/js/jquery.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/contact_add_local.js"></script>
...
<TABLE BORDER="1">
  ...
  <TR>
    <TD>Office Code:</TD>
    <TD><INPUT TYPE="TEXT" NAME="office_code" id="office_code" SIZE="25" readonly></TD>
  </TR>
  <TR>
    <TD>Office Name:</TD>
