...
<form:form method="POST" action="/HelloWorldDemo/addVals" commandName="objContact">
   <table>
   <tr>
...
<tr>
<td><form:label path="office_code"> OfficeNo:</form:label></td><td><form:input path="office_code" /></td>
</tr>
<tr>
