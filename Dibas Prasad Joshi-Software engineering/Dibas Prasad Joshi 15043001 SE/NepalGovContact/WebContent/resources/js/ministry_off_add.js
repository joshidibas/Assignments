...
$(document).ready(function(){
			...
			$.post(ppath, {
			   ...
			   tabledata:  JSON.stringify(sendInfo),
				...
				//$('#ajaxResponse').text(responseText);
					  try
					  {
					    var tbl_body = "<table border='1' cellspacing='5'> <thead> <th>min_code</th><th>min_name</th><th>office_code</th><th>office_name</th><th>Edit Record</th><th>Delete Record</th> </thead>";
					    var odd_even = false;
					    $.each(data, function() {
					        var tbl_row = "";
					        var orgkey="";
    ...
    $('#btn_add_ministry_office').click(function (e) {
 	   ...
 	   var sendInfo = {ministry_code:ministry_code,office_code:office_code,office_name:office_name,org_type_code:org_type_code };
 	   var requestpath=$(location).attr('pathname');
		  ...
		  if(rpath == "AddItem.jsp")
			  {
			    ppath="../NepalGovContact/aMinOffRecord/";
			  }
